...
def hórus():
	...
	def bannner(host, porta):
		...
		if porta == 22:
			...
			if software in banner:
				print("Software: ", software, " encontrado ✓")
	...
	while xx == True:
		...
		if inp == "sair":
			...
			porta = int(input("PORTA: "))
			dispp = int(input("N° DE DISPOSITIVOS: "))
			print("\n\n")
			func2(servico, porta, dispp)
			
			
		elif inp == "3":
			print("\n    LOCALIZADOR DE SOFTWARE EM PORTA POR VERSÃO\n")
			servico = input("SERVIÇO / S.O: ")
			porta = int(input("PORTA: "))
			disp = int(input("N° DE DISPOSITIVOS: "))
			print("\n\n")
			func3(servico, porta, disp)
...
print("\n\n############  ########  ##### ### ######  ########  ######## # ##  #####")
print ("####### ### ### ##### --|", nomep, "|-- #########\033[36m v[1.1] \033[0;0m#########")
print("######## ####  ####### ############ ######## # ## #####  # # #  #### ### \n\n")
